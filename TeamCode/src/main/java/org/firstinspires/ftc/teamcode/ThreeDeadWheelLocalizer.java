...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2226.6282200089704; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2316.849877039383; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 1026.6291191002351; // x position of the perpendicular encoder (in tick units)
    }
